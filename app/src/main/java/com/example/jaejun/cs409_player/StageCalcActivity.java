...
public class StageCalcActivity extends AppCompatActivity{

    Intent stagePlayIntent = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stagePlayIntent.putExtra("mode", "calc");
    ...
    public void startCalc(int iteration){
        for (int i=0; i<iteration; i++){
            startActivityForResult(stagePlayIntent, 0);
        }
    }
